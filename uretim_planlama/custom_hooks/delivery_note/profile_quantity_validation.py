# -*- coding: utf-8 -*-
"""
Delivery Note profil miktar doğrulama ve otomatik hesaplama
"""
...
def before_save(doc, method):
    """Delivery Note kaydedilmeden önce profil miktarlarını doğrula"""
    validate_profile_quantities(doc, method)


def validate(doc, method):
    """Delivery Note validasyon sırasında profil miktarlarını kontrol et"""
    validate_profile_quantities(doc, method)
